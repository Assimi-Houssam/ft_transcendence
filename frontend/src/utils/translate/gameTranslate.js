export const langOfflineMode = {
    en : {
        ...
        BtnOnlineMode : "Online Mode",
    },
    fr : {
        BtnOfflineMode : "Mode hors ligne",
        BtnOnlineMode : "Mode en ligne",
    },
    es : {
        BtnOfflineMode : "Modo fuera de línea",
        BtnOnlineMode : "Modo en línea",
    }
}
...
export const langNextTournament = {
    en : {
        Results : "Results",
        NextUpTitle : "Next Up!",
...
export const langChatGame = {
    en : {
        chatTitle : "Room Chat",
        Placeholder : "Type something..."
    },
    fr : {
        chatTitle : "Chat de la salle",
...
export const langInviteFriendsPopup = {
    en : {
        Online : "Online",
        Offline : "Offline",
        invite : "Invite!",
...
export const langRoomInfoCard = {
    en : {
        Title : "Online rooms",
        BtnCreateRoom : "Create Room",
    },
    fr : {
        Title : "Salles en ligne",
        BtnCreateRoom : "Créer une salle",
    },
    es : {
        Title : "Salas en línea",
...
export const langSearch = {
    en : {
        ...
        FaildLoadData : "Failed to load data",
        NoResults : "No results match your search",
        EnterSomthing : "Please enter somthing to start searching.",
    },
    fr : {
        PlaceHolder : "Rechercher un utilisateur par e-mail ou nom d'utilisateur",
        FaildLoadData : "Échec du chargement des données",
        NoResults : "Aucun résultat ne correspond à votre recherche",
        EnterSomthing : "Veuillez entrer quelque chose pour commencer la recherche.",
    },
    es : {
        PlaceHolder : "Buscar usuario por correo electrónico o nombre de usuario",
        FaildLoadData : "Error al cargar los datos",
