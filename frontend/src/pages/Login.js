export  function LoginPage() {
	...
	<form class="login-form">
		...
		<div class="buttons">
			...
			<p class="space">OR</p>
			<button type="submit" class="secondary-btn"><span><img src="../images/42.svg" alt="42" class="fortyTwo"></span><span> Login with Intranet</span></button>
		</div>
	</form>
	<p class="ref">You are new here? create account by clicking <a class="anchor" href="/frontend/register">here</a></p>
</div>
</div>
	`
	return home;
